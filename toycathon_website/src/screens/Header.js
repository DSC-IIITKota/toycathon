...
function Header() {
    ...
    return (
        <header id="header">
            <div class="container">
                <nav>
                <div class="nav-brand"><a href="#home"><img class="ani-logo" style={{width:'80px',height:'100px', marginTop: '-15px'}} src="asd.png"></img></a></div>                   
                 <div class="menu-icons open">
                    ...
                    <ul class="nav-list">
                        ...
                        <li class="nav-item">
                            <a href="/timeline" class="nav-link-item current">Schedule</a>
                        </li>
                        <li class="nav-item">
