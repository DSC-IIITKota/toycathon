...
function Team(){
    return(<section id="team" class="pricing">
    <div class="container">
      ...
      <div class="col-lg-4 col-md-6">
          <div class="box team-box" data-aos="zoom-in">
            {/* <h3>Free</h3> */}
            <img className="team-img" src="/assets/img/akvyas.jpeg"></img>
            <h4 class="team-name">Dr. A.K. Vyas</h4>
            <h6>Co-ordinator,IIIT Kota</h6>
      ...
      <div class="row team"> 
        ...
        <div class="col-lg-4 col-md-6 mt-4 mt-lg-0">
            <div class="box team-box" data-aos="zoom-in">
                {/* <h3>Free</h3> */}
                <img className="team-img" src="/assets/img/mehul.jpg"></img>
